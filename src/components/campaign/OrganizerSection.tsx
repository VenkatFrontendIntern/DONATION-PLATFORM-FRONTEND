...
export const OrganizerSection: React.FC<OrganizerSectionProps> = ({ organizer, socialMedia }) => {
  const hasSocialMedia = socialMedia && Object.values(socialMedia).some(link => link);
    ...
    <div className="bg-white p-6 md:rounded-2xl shadow-sm">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            Verified Organization <ShieldCheck className="inline w-3 h-3 text-green-500" />
          </p>
        </div>
      </div>
      ...
      {hasSocialMedia && (
        <div className="border-t pt-4 mt-4">
          <h4 className="text-sm font-semibold text-gray-700 mb-3">Connect with Organizer</h4>
          <div className="flex flex-wrap gap-2">
            ...
            {socialMedia.instagram && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-2 bg-pink-50 text-pink-600 rounded-lg hover:bg-pink-100 transition-colors text-sm"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {socialMedia.twitter && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-2 bg-sky-50 text-sky-600 rounded-lg hover:bg-sky-100 transition-colors text-sm"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
