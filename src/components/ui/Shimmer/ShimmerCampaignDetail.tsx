        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <Shimmer className="h-4 w-24 rounded mb-4" animationType={animationType} />
                <ShimmerText lines={4} lineHeight="md" animationType={animationType} />
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-8">
              ...
              <ShimmerText lines={2} lineHeight="sm" className="mb-6" animationType={animationType} />
              <Shimmer className="h-12 w-full rounded-xl" variant="bright" animationType={animationType} />
            </div>
          </div>
        </div>
      </div>
